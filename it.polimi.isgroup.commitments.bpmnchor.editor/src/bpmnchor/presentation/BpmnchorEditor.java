...
/**
 * This is an example of a Bpmnchor model editor.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class BpmnchorEditor extends MultiPageEditorPart
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(BpmnchorModelWizard.FILE_EXTENSIONS, "*.");
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "it.polimi.isgroup.commitments.bpmnchor.editor",
					 0,
					 null,
	...
	public void doSaveAs() {
		...
		String[] files = BpmnchorEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
