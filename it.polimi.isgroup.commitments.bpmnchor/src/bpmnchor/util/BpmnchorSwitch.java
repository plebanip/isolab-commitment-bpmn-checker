 ...
 * @generated
 */
public class BpmnchorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BpmnchorPackage.MONITORING_RESOURCE: {
				MonitoringResource monitoringResource = (MonitoringResource)theEObject;
				T result = caseMonitoringResource(monitoringResource);
				if (result == null) result = caseRootElement(monitoringResource);
				if (result == null) result = caseBaseElement(monitoringResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnchorPackage.COMMITMENT_EXPRESSION: {
			...
			case BpmnchorPackage.DEFINITIONS: {
				Definitions definitions = (Definitions)theEObject;
				T result = caseDefinitions(definitions);
				if (result == null) result = caseBpmn2_Definitions(definitions);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Monitoring Resource</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Monitoring Resource</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMonitoringResource(MonitoringResource object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Commitment Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Commitment Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCommitmentExpression(CommitmentExpression object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseBpmn2_Definitions(org.eclipse.bpmn2.Definitions object) {
		return null;
	}
